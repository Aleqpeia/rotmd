...
from protein_orientation.models.energy import TotalEnergy
from protein_orientation.base import membrane_interface
from protein_orientation.core.inertia import inertia_tensor
...
if __name__ == '__main__':
    ...
    print("Example usage:")
    print()
    print("from protein_orientation.io.gromacs import load_gromacs_trajectory, detect_trajectory_contents")
    print()
