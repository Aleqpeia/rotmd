...
def analyze_helix(
    aligned: mda.Universe, selection: str, output_file_handle: io.TextIOBase
) -> None:
...
def get_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--sel-helix", metavar="selection", help="Atom selection for helix analysis"
    )
    parser.add_argument(
        "-rt",
        "--ref-frame-type",
        choices=["specific", "average"],
        default="specific",
        metavar="TYPE",
